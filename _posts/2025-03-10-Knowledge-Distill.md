...
It's inspired by the chemial distrillation process and have the following parallel relationship:
...
- Training and Knowledge Transfer 🔄: The teacher AI looks at lots of data and gives the correct answers (called "hard labels") and explains why these answers are correct and what other possible answers might be (called "soft labels").
